...
%--------------------------------------------------------------------------
function [nu_up_l0,nu_up_l1,nu_up_l2] = diag_echelle_UP_RG_V2(nu_bk,PDS_w,Dnu,nu_max,KIC,dir_figue,N_liss,N_n,max_val_psd,offset_X,nu_inf)
...
% eps      = 0.634 + 0.546*log10(Dnu); 
alpha_l0 = 0.008; % D'apres table 1 du papier de Benoit
alpha_l1 = 0.003;
alpha_l2 = 0.005;
...
if exist('offset_X','var') == 0; offset_X = 1; end
if exist('nu_inf','var')   == 0; nu_inf = max([n_max-N_n/2 0])*Dnu - offset_X; end
